...
namespace WindowsFormsApp17
{
    public partial class Form2 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(usuario2.Text) && !String.IsNullOrEmpty(contraseña2.Text) && !String.IsNullOrEmpty(Ccontraseña.Text) && !String.IsNullOrEmpty(edad1.Text) && !String.IsNullOrEmpty(diabetes1.Text) && !String.IsNullOrEmpty(peso1.Text) && !String.IsNullOrEmpty(estatura.Text) && (radioButton1.Checked || radioButton2.Checked))
            {
                ...
                string sexo = "";
                string diabetesu = diabetes.ToUpper();
                ...
                string estaturaa = estatura.Text;
                ...
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    {
                        string insertQuery = "INSERT INTO usuarios (usuario, contraseña, edad, diabetes, tipodiabetes, peso, sexo, altura) VALUES (@usuario, @contraseña, @edad, @diabetes, @tipodbts, @peso, @sexo, @altura)";
                        using (MySqlCommand command = new MySqlCommand(insertQuery, connection))
                        {
                            command.Parameters.AddWithValue("@usuario", usuario);
                            command.Parameters.AddWithValue("@contraseña", contraseña);
                            command.Parameters.AddWithValue("@edad", edad);
                            command.Parameters.AddWithValue("@diabetes", diabetesu);
                            command.Parameters.AddWithValue("@tipodbts", tpodbts);
                            command.Parameters.AddWithValue("@peso", peso);
                            command.Parameters.AddWithValue("@sexo", sexo);
                            command.Parameters.AddWithValue("@altura", estaturaa);
