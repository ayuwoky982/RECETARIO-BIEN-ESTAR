...
namespace WindowsFormsApp17
{
    public partial class Form5 : Form
    {
        ...
        #region Recetas, consejos, filtrado, categorización, favoritos, descarga y visualización de perfil de usuario

        // RadioButton Mostrar consejos
        ...
        // Seleccionado de tipo de comida
                    ...
                    using (MySqlCommand command = new MySqlCommand(query, connection))
                    {
                        ...
                        foreach (DataGridViewRow row in dataGridView1.Rows)
                        {
                            if (row.Cells["Número de receta"].Value != null)
                            {
                                ...
                                if (esFavorito)
                                    row.Cells["Favorito"].Value = Properties.Resources.estrella_llena;
                                else
                                    row.Cells["Favorito"].Value = Properties.Resources.estrella_vacia;
                            }
                        }
                    }
                }
        ...
        private void lblVerPerfilUsuario_Click(object sender, EventArgs e)
        {
